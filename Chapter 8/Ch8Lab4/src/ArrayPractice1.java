...
public class ArrayPractice1 extends JFrame
{
   ...
   public ArrayPractice1( )
   {
     ...
     c.add( findMinimum );
     sortValues = new JButton("Sort Values");
     c.add(sortValues);
     ...
     sortValues.addActionListener( bh );
   ...
   */
   ...
   private class ButtonHandler implements ActionListener
   {
      ...
      public void actionPerformed( ActionEvent e )
      {
          ...
          else if(e.getSource() == sortValues) // added
          {
	          disableButtons();
	          sortValues.requestFocus();
	          bc.setActivity( 5 );
	          sortArray();
	          printArray();
	          t.start();
